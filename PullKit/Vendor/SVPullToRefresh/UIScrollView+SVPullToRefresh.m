...
- (void)layoutSubviews {
    ...
    self.titleLabel.hidden = YES; //hasCustomView;
    self.subtitleLabel.hidden = YES;// hasCustomView;
    ...
    if(hasCustomView) {
        ...
        switch (self.state) {
            ...
            case SVPullToRefreshStateStopped:
                //                self.arrow.alpha = 1;
                [_overlayImageView stopAnimating];
        ...
        CGFloat leftViewWidth = MAX(self.arrow.bounds.size.width,self.overlayImageView.bounds.size.width);
        ...
        self.arrow.center = CGPointMake(CGRectGetMidX(self.frame), 30);
        self.overlayImageView.center = self.arrow.center;
    }
}
